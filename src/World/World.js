...
class World {
  constructor(container) {
   ...
   // Scene.setBackgroundTexture(scene, 'src/World/assets/textures/backgrounds/starry_night_sky.jpg');
    ...
    gltfLoader.load('src/World/assets/textures/pool_balls/textures/scene.gltf', (gltf) => {
      ...
      scene.add(model);
          ...
          const gltfLoaderCue = new GLTFLoader();
    gltfLoaderCue.load('src/World/assets/textures/pool_cue/textures/scene.gltf', (gltf) => {
      const model = gltf.scene;
      model.position.y = 2;
      model.position.x = 0;
      model.position.z = 4;
    ...
    mainGroup.add(Floor.createBoxFloor(8, 11, 0.4));
